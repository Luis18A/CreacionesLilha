...
import com.creacionesLilha.service.LoginUsuarioServiceImp;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
			...
			.antMatchers("/","/home","/contacto").permitAll()
				// funcionando
				.antMatchers("/agregarRegistro/","/nuevoTripulante","/nuevoVehiculo").hasAuthority("Cliente")
				// funcionando
				.antMatchers("/consultas").hasAuthority("Vendedor")
